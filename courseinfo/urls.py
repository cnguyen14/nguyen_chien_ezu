...
from courseinfo.views import (
    ...
    InstructorDetail,
    SectionDetail,
    SemesterDetail, StudentDetail, CourseDetail,
    RegistrationDetail, InstructorCreate, SectionCreate, CourseCreate,
    RegistrationCreate, SemesterCreate, StudentCreate,
    InstructorUpdate, SectionUpdate, StudentUpdate, SemesterUpdate,
    CourseUpdate, RegistrationUpdate, RegistrationDelete, InstructorDelete,
    SectionDelete, StudentDelete, SemesterDelete, CourseDelete,
)
